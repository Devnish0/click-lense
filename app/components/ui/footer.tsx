...
export default function Footer() {
  return (
    <footer className="fixed bottom-0 w-full border-t bg-background/80 backdrop-blur-sm border-border/50 ">
      <div className="flex py-6 items-center justify-center gap-3 flex-col">
        <div className="flex lg:flex-row lg:justify-around lg:w-full flex-col items-center justify-center gap-3">
          ...
          <div className="flex gap-3">
            <img
              src="/twitter.svg"
              alt="twitter"
              className="w-4 h-4 opacity-30 hover:opacity-100 transition-opacity"
            />
            <img
              src="/github.svg"
              alt="github"
        ...
        <span className=" flex  items-center justify-center gap-1">
          ...
          <a
            ...
            className="font-extrabold text-[12px] text-black/80"
          >
            Nishank
          </a>
        </span>
